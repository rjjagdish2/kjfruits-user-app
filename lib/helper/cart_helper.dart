...
class CartHelper {
  static CartModel? getCartModel(Product product, {List<int>? variationIndexList, int? quantity}){
    ...
    priceWithDiscount = PriceConverterHelper.convertProductDiscount(
      price: price,
    ...
    cartModel = CartModel(
      ...
      (priceWithDiscount - PriceConverterHelper.convertWithDiscount(priceWithDiscount, product.tax, product.taxType)!),
