...
class _CustomTextFieldWidgetState extends State<CustomTextFieldWidget> {
          ...
          child: TextFormField(
            ...
            decoration: InputDecoration(
              ...
              enabledBorder: !widget.isShowBorder ? InputBorder.none : OutlineInputBorder(
                ...
                borderSide: BorderSide(width: 1 , color: Theme.of(context).hintColor.withValues(alpha: 0.2)),
              ),
  ...
  Color _getSelectionColor(){
    ...
    if(widget.focusNode != null){
      return widget.focusNode!.hasFocus ? Theme.of(context).primaryColor : Theme.of(context).hintColor.withValues(alpha: 0.3);
    }else{
      return widget.prefixAssetImageColor ?? Theme.of(context).primaryColor;
    }
  }
