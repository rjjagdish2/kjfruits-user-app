...
class CategoryProductScreen extends StatefulWidget {
  ...
  const
  CategoryProductScreen({super.key,required this.categoryId, this.categoryName});
              ...
              return Column(
                ...
                children: [
                                    ...
                                    Padding(
                                      ...
                                      child: InkWell(
                                        onTap: (){
                                          ...
                                          productProvider.initCategoryProductList(widget.categoryId, 1);
                                        },
                                        ...
                                        itemBuilder: (BuildContext context, int index){
                                          return InkWell(
                                            onTap: (){
                                              ...
                                              productProvider.initCategoryProductList('${categoryProvider.subCategoryList![index].id}', 1);
                  ...
                  Expanded(child: CustomScrollView(controller: scrollController, slivers: [
                    SliverToBoxAdapter(child: (productProvider.subCategoryProductList?.products ?? []).isNotEmpty ? Center(
                      child: PaginatedListWidget(
                        scrollController: scrollController,
                        onPaginate: (pageIndex){
                          productProvider.initCategoryProductList(widget.categoryId, pageIndex ?? 1);
                        },
                        totalSize: productProvider.subCategoryProductList?.totalSize,
                        offset: productProvider.subCategoryProductList?.offset,
                        itemView: SizedBox(
                          ...
                          child: GridView.builder(
                            ...
                            physics: const NeverScrollableScrollPhysics(),
                            itemCount: productProvider.subCategoryProductList?.products?.length,
                            shrinkWrap: true,

                            itemBuilder: (BuildContext context, int index) {
                              return ProductWidget(product: productProvider.subCategoryProductList!.products![index], isCenter: true, isGrid: true);
                            },
