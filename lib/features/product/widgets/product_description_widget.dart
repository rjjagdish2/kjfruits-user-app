        ...
        tabIndex == 0 ? Stack(children: [
          ...
          Container(
            ...
            child: IntrinsicHeight(
              child: Row(children: [
                Padding(
                  padding: EdgeInsets.symmetric(horizontal: ResponsiveHelper.isDesktop(context) ? Dimensions.paddingSizeExtraLarge : Dimensions.paddingSizeExtraSmall),
                  child: Column(crossAxisAlignment: CrossAxisAlignment.center, mainAxisAlignment: MainAxisAlignment.center, children: [
                    ...
                    RatingBarWidget(
                      ...
                      productProvider.product!.rating![0].average! : 0.0, size: Dimensions.paddingSizeLarge,
                    ),
                    const SizedBox(height: Dimensions.paddingSizeExtraSmall),
                ...
                Padding(
                  ...
                  child: VerticalDivider(color: ColorResources.cartShadowColor.withValues(alpha: 0.5), width: 1),
                ),

                Expanded(child: Padding(
                  padding: EdgeInsets.symmetric(vertical: Dimensions.paddingSizeSmall, horizontal: ResponsiveHelper.isDesktop(context) ? Dimensions.paddingSizeExtraLarge : Dimensions.paddingSizeSmall),
