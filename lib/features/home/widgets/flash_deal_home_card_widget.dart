    ...
    return Consumer<FlashDealProvider>(builder: (context, flashDealProvider, child) {
      ...
      Column(children: [
        ...
        InkWell(
          ...
          onTap: () => RouteHelper.getHomeItemRoute(ProductType.flashSale),
          child: Container(
              ...
              InkWell(
                ...
                child: Padding(
                  ...
                  child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                    Text(
                      'view_all'.tr,
                      style: poppinsRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).primaryColor.withValues(alpha: 0.8)),
                    ),
