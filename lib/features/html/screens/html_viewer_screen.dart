              ...
              child:  SingleChildScrollView(
                ...
                child: Column(children: [
                  ResponsiveHelper.isDesktop(context)
                      ? Text(appBarText.tr, style: poppinsBold.copyWith(fontSize: 28,color: Theme.of(context).textTheme.bodyLarge?.color?.withValues(alpha: 0.6)))
                      : const SizedBox.shrink(),
                  const SizedBox(height: Dimensions.paddingSizeSmall),

                  SizedBox(
                    height: ResponsiveHelper.isMobilePhone() ? 50 : 100, width: Dimensions.webScreenWidth,
                  ...
                  Padding(
                    ...
                    child: HtmlWidget(
                      ...
                      textStyle: poppinsRegular.copyWith(color: Theme.of(context).textTheme.bodyLarge?.color),
                      onTapUrl: (String url){
