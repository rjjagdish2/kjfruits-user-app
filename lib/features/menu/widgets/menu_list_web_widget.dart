...
class MenuListWebWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final List<MenuModel> menuList = [
      MenuModel(icon: Images.orderList, title: getTranslated('my_order', context), route:()=>  RouteHelper.getOrderListScreen()),
      MenuModel(icon: Images.trackOrder, title: getTranslated('order_track', context), route: ()=> RouteHelper.getOrderSearchRoute()),
      MenuModel(
        icon: Images.editProfile, title: getTranslated('profile', context),
        route: ()=> isLoggedIn ? RouteHelper.getProfileEditRoute() : RouteHelper.getLoginRoute(),
      ),
      MenuModel(icon: Images.addressList, title: getTranslated('address', context), route: ()=> RouteHelper.getAddressListScreen()),
      ...
      MenuModel(icon: Images.coupon, title: getTranslated('coupon', context), route: ()=> RouteHelper.getCouponRoute()),
      MenuModel(icon: Images.notification, title: getTranslated('notification', context), route: ()=> RouteHelper.getNotificationScreen()),
      ...
      MenuModel(
          icon: isLoggedIn ? Images.logOut : Images.logIn,
          title: getTranslated(isLoggedIn ? 'log_out' : 'login', context),
          route: ()=> isLoggedIn ? showDialog(
