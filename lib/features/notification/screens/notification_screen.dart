      ...
      child: Scaffold(
        ...
        body: RefreshIndicator(
          ...
          child: CustomScrollView(
            slivers: [
              SliverToBoxAdapter(
                child: ResponsiveHelper.isDesktop(context) ? Padding(padding: const EdgeInsets.symmetric(vertical: Dimensions.paddingSizeExtraLarge),
                child: Center(child: Text("notification_list".tr, style: poppinsSemiBold.copyWith(fontSize: Dimensions.fontSizeLarge))),
              ) : const SizedBox(),
              ),
