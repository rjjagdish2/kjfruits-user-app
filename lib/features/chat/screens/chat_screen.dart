        ...
        body: _isLoggedIn ? Center(child: SizedBox(
          ...
          child: Column(children: [
            ResponsiveHelper.isDesktop(context) ? Padding(padding: const EdgeInsets.symmetric(vertical: Dimensions.paddingSizeExtraLarge),
              child: Center(child: Text("chat".tr, style: poppinsSemiBold.copyWith(fontSize: Dimensions.fontSizeLarge))),
            ) : const SizedBox(),
            ...
            Padding(
              ...
              child: Container(
                ...
                Row(children: [
                    InkWell(
                      onTap: () async {
                        Provider.of<ChatProvider>(context, listen: false).onPickImage(context, false);
                      },
                      child: Padding(
