            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Row(mainAxisAlignment: MainAxisAlignment.start, children: [
                ...
                TextButton(
                  ...
                  child: Row(children: [
                    Text('+', style: poppinsBold.copyWith(color: Theme.of(context).primaryColor, fontSize: 18)),
                    const SizedBox(width: Dimensions.paddingSizeExtraSmall),

                    Text(getTranslated(deliveryAddress == null || orderProvider.addressIndex == -1  ? 'add' : 'change', context), style: poppinsBold.copyWith(color: Theme.of(context).primaryColor)),
                  ]),
                ),
              ...
              deliveryAddress == null || orderProvider.addressIndex == -1 ? Padding(
                ...
                child: Center(child: Text(getTranslated('no_address_available', context), style: poppinsRegular)),
