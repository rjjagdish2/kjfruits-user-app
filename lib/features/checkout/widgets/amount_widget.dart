              ...
              if(orderProvider.partialAmount != null) Column(children: [
                Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                  ...
                  CustomDirectionalityWidget(
                    child: Text(PriceConverterHelper.convertPrice(context, orderProvider.partialAmount ?? 0),
                      style: poppinsRegular.copyWith(fontSize: Dimensions.fontSizeLarge),
                    ),
                  ),
                ]),
                ...
                Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                  ...
                  CustomDirectionalityWidget(
                    child: Text(PriceConverterHelper.convertPrice(context, total + (weight ?? 0) - (orderProvider.partialAmount ?? 0)),
                      style: poppinsRegular.copyWith(fontSize: Dimensions.fontSizeLarge),
                    ),
                  ),
